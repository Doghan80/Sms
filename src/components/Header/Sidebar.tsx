...
function Sidebar({ isSidebarOpen }: SideProps) {
  return (
    ...
    <aside
      className={`fixed top-0 left-0  z-40 h-full pt-20 bg-white border-r shadow border-r shadow-sm dark:bg-hover dark:border-hover transition-transform duration-300 ease-in-out transform ${!isSidebarOpen ? 'translate-x-0 ' : '-translate-x-full'}`}
    >
